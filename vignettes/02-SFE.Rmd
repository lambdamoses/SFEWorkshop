...
### Column and row
Column and row geometries can be get or set with the `dimGeometries` (multiple items) or `dimGeometry` (one item) function. The `MARGIN` argument is as in the `apply` function: `MARGIN = 1` means row, and `MARGIN = 2` means column.
