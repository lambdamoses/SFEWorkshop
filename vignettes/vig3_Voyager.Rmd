...
```{r, fig.alt="Density plot of Geary's C values from 100 simulations of nCounts and nGenes. The density plots center around 1 and deminish around 0.94 on the left. Vertical lines mark the actual Geary's C. For both nCounts and nGenes, the actual value, at 0.47 and 0.71 respectively, is far lower than the simulated ones, indicating positive spatial autocorrelation."}
